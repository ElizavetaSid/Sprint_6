...
class MainPageFAQ(BasePage):
    ...
    def click_on_faq_item(self, data):
        self.click_on_element_with_wait(MainPagesLocators.FAQ_SECTION_ITEM_QUISTIONS[data])
    ...
    @allure.step('Нажать на кнопку согласия с куки "да все привыкли"')
    def click_on_button_cookie(self):
        self.click_on_element(MainPagesLocators.COKKIES_BUTTON)