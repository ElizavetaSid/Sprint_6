class TestData:
    YANDEX_SCOOTER = 'https://qa-scooter.praktikum-services.ru/'


    test_data_faq_answer = [
    ...
    test_data_user1 = ['Елизавета', 'Алексеева', 'Юбилейный пр-кт', 'Новокосино', '+79272182207', '26.09.2025', 'Приветики-пистолетики']
    test_data_user2 = ['Александр', 'Пушкин', 'Немецкая', 'Бауманская', '+79995305035', '28.09.2025', 'Мы все учились понемногу чему-нибудь и как-нибудь']